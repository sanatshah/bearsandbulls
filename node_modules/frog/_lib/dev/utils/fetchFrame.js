...
import { FrameActionBody, NobleEd25519Signer, makeFrameAction, } from '@farcaster/core';
import { bytesToHex, hexToBytes } from '@noble/curves/abstract/utils';
import { ed25519 } from '@noble/curves/ed25519';
export async function fetchFrame(parameters) {
    ...
    const frameActionMessage = await makeFrameAction(frameActionBody, { fid, network: 1 }, new NobleEd25519Signer(privateKeyBytes));
    ...
    try {
        ...
        return await fetch(url, {
            ...
            body: JSON.stringify({
                ...
                trustedData: {
                    messageBytes: Buffer.from(Message.encode(message).finish()).toString('hex'),
                },
            }),
        });
    }
