import { type FrameContext, type FrameImageAspectRatio, type FrameVersion } from '../types.js';
...
export type UserDataByFidResponse = {
    messages: {
        data: {
            ...
            userDataBody: {
                type: 'USER_DATA_TYPE_PFP' | 'USER_DATA_TYPE_USERNAME' | 'USER_DATA_TYPE_DISPLAY';
                value: string;
            };
        };
    }[];
