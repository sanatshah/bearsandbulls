...
export function Preview(props) {
    return (_jsxs("div", { "x-data": `{
      ...
      }`, class: "flex flex-col container md:grid md:container gap-4 md:gap-6", style: {
            maxWidth: '1512px',
            marginLeft: 'auto',
            marginRight: 'auto',
        }, children: [_jsxs("aside", { class: "order-1 space-y-4 md:min-w-sidebar lg:min-w-sidebar w-full", style: {
                    position: 'sticky',
                    top: '1.5rem',
                    alignSelf: 'start',
                }, children: [_jsx(Timeline, {}), _jsx(QuickLinks, {})] }), _jsxs("main", { class: "flex flex-col md:h-full w-full gap-4 order-0 md:order-1 overflow-hidden", children: [_jsx(Navigator, {}), _jsxs("div", { class: "flex flex-col lg:flex-row gap-4", children: [_jsxs("div", { class: "flex flex-col gap-4", children: [_jsx(Metrics, {}), _jsx(Frame, {})] }), _jsx(Data, {})] }), _jsx(Tabs, {})] })] }));
}
